...
<div id="page-container" class="row">
            ...
            <ul class="list-group">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu scrollable-menu" role="menu">
                        <li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Shipment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Shipment.id'))); ?></li>
    ...
    <div id="page-content" class="col-sm-9">
        ...
        <h2><?php echo __('Edit Shipment'); ?></h2>
